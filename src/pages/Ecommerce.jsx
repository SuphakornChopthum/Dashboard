...
const Ecommerce = () => {
  ...
  return (
    <div className='mt-2'>
      <div className='flex flex-wrap lg:flex-nowrap justify-content'>
      ...
      <div className="flex gap-10 flex-wrap justify-conter">
          ...
          <div className='mt-10 flex gap-10 flex-wrap justify-center'>
            <div className='border-r-1 border-color m-4 pr-10'>
              <div>
                ...
                <p className='text-gray-500 mt-1'>Budgey
                </p>
              </div>
              <div className='mt-8'>
                <p>
                ...
                <p className='text-gray-500 mt-1'>Expense
                </p>
              </div>
